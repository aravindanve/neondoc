...
import { OasSchemaRoot } from './OasSchemaRoot';

export const OasResponses = ({ responses }) => {
  const initialCode = responses && responses.hasOwnProperty('200') ? '200' : Object.keys(responses).pop();
      ...
      <>
        <SectionSimple>
          ...
          {selectedMediaTypeObject && selectedMediaTypeObject.schema ? (
            <SectionSimpleContent>
              <OasSchemaRoot schema={selectedMediaTypeObject.schema} />
